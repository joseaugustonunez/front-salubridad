...
function CambiarPage() {
  ...
  const handleResetPassword = async (e) => {
    ...
    if (!token) {
      setError("No se encontró un token válido. Solicita un nuevo enlace de restablecimiento.");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      setError("No pudimos cambiar tu contraseña. El enlace podría haber expirado.");
    } finally {
      setLoading(false);
    }
  };
