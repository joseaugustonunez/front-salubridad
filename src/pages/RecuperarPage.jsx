    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 pt-10">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md mt-16">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-[#254A5D]">Recuperar Contraseña</h2>
          {!isSubmitted ? (
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-3xl text-white bg-teal-500 hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-200 disabled:opacity-50"
              >
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-teal-700">
                    Hemos enviado un correo electrónico a {email} con instrucciones para restablecer tu contraseña. Revisa tu bandeja de entrada y sigue las instrucciones.
                  </p>
                </div>
              </div>
            </div>
